...
def tokenize():
	...
	def tokenised(news,sentimentTraining,stemmedVerbSentimentTraining):
		tokenised_news =[]
		bag_of_verb = []
	...
	# i = 1
		...
		for i in bag_of_distinct_stemmed_verb:
		# i = str(i)
		...
		for i in a:
			print(i)
			t = stemmedVerbSentimentTraining(s_no= s_n[count],stemmedVerb = i)
			t.save()
			count +=1
